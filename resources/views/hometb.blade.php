    ...
    <div class="card table-card">
      <div class="card-header">
        ...
        <div class="form-inline">
          ...
          <button type="submit" class="btn  btn-primary mb-2" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-plus mr-2"></i>Add Worker</button>
        </div>
                ...
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                      <input type="text" class="form-control" name="fullname" placeholder="Fullname" style="width: 100%;" required>
                    </div>   
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="phone" class="form-control" name="phone"  required placeholder="(+998) 99-000-00-00" value="+998" style="width: 100%;">
                    </div>
                    <div class="form-group">
