    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                     <a href="{{route('home')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-cannabis"></i></span><span class="pcoded-mtext">Relays</span></a>
                </li>
               <li class="nav-item">
                     <a href="{{route('archive')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-archive"></i></span><span class="pcoded-mtext">Archive</span></a>
               </li>
               <li class="nav-item">
                     <a href="{{route('numbers')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-phone-square"></i></span><span class="pcoded-mtext">Phone Numbers</span></a>
               </li>
               
               <li class="nav-item">
                     <a href="{{route('commentrelays')}}" class="nav-link "><span class="pcoded-micon"><i class="fa fa-comments"></i></span><span class="pcoded-mtext">Comments</span></a>
               </li>
