                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('home') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="fa fa-users"></i></span><span class="pcoded-mtext">Реле</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('departments') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="fa fa-phone-square"></i></span><span
                                class="pcoded-mtext">Станции</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('numbers') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="fa fa-users"></i></span><span
                                class="pcoded-mtext">Механики</span></a>
                    </li>
                    
                    <li class="nav-item">
                        <a href="{{ route('organizations') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="fa fa-phone-square"></i></span><span
                    ...
                    <li class="nav-item">
                        <a href="{{ route('commentrelays') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="fa fa-comments"></i></span><span class="pcoded-mtext">Доп</span></a>
                    </li> --}}
                </ul>
            </div>
        </div>
