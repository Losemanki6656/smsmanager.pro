                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Добавить станции</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                        aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="name" placeholder="Станция"
                                        style="width: 100%;" required>
                                </div>
                                <div class="form-group">
                                    <label for="organization_phone">Участка</label>
                                    <select class="form-control" name="organization_id" style="width: 100%;" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="number_id" style="width: 100%;" required>
                                        @foreach ($numbers as $number)
                                            <option value="{{ $number->id }}">{{ $number->fullname }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="table-responsive">
                            <div class="customer-scroll" id="rec-table">
                                @include('includes.include-departments')
                            </div>
                        </div>
                    </div>
